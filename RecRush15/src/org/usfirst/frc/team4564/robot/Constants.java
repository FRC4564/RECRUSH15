...
public class Constants {
	...
	public static final int DIO_CARRIAGE_TOP = 10;  // Top Carriage limit switch
	public static final int DIO_VERTICAL_WRIST =  11;  // Vertical limit switch on wrist
	public static final int DIO_HORIZONTAL_WRIST =  12;  // Horizontal limit switch on wrist
